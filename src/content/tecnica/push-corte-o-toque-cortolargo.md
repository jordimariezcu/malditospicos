...
Utilidad:
- Controla el ritmo del punto y evita ataques directos del rival.
- Se usa para responder saques cortos o mantener el juego táctico.

Beneficios:
- Mantiene la pelota baja y difícil de atacar.
- Permite preparar un contraataque o esperar el error del rival.
