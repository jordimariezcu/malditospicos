...
Ventajas:
- Dificulta mucho el ataque del rival.
- Controla el ritmo del punto.
- Permite forzar errores sin necesidad de arriesgar.

Desventajas:
- Requiere gran técnica y condición física.
- Las pelotas pueden ser más lentas.
- Menor iniciativa ofensiva si no se alterna con ataque.

**Pala recomendada:**
Madera OFF- o ALLROUND DEFENSIVE, con buen control y flexibilidad.
Ejemplo: Butterfly Joo SaeHyuk, Donic Defplay Senso, TSP Balsa 3.5

**Gomas recomendadas:**
Revés: Picos largos para cortar (ej. Tibhar Grass D.TecS, Butterfly Feint Long III)
Derecha: Goma lisa controlada con efecto para atacar cuando se pueda (ej. Victas VS>401, Butterfly Tenergy 05 FX)